...
<html lang="en" class="light-style layout-menu-fixed layout-compact" dir="ltr" data-theme="theme-default" data-assets-path="<?= base_url('/'); ?>dashboard/assets/" data-template="vertical-menu-template-free">
