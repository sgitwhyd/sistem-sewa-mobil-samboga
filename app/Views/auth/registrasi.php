...
<!-- title -->
  <?= $this->section('title'); ?>
  <title>Registration - SAMBOGA RENT CAR</title>
  <?= $this->endSection(); ?>
            ...
            <div class="card-body">
              ...
              <form id="formAuthentication" class="mb-3" action="" method="POST">
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" id="first_name" name="first_name" placeholder="Enter your first name" autofocus value="<?= old('first_name'); ?>"/>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3 form-password-toggle">
                  ...
                  <div class="input-group input-group-merge">
                    <input type="password" id="conf_password" class="form-control" name="conf_password" placeholder="&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;&#xb7;" aria-describedby="password" />
                    <span class="input-group-text cursor-pointer"><i class="bx bx-hide"></i></span>
                  </div>
                </div>
