 ...
 <?= $this->section('content'); ?>
          ...
          <div class="modal fade" id="viewTransaction" tabindex="-1" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
              ...
              <?php endif ?>
              <div class="mb-3">
                <a href="<?= base_url('admin/add-transaction'); ?>" class="btn btn-primary"><i class='bx bx-plus me-1'></i> Tambah</a>
              </div>
              <div class="card mb-4">
                <div class="card-body">
                          ...
                          <td>
                            <div class="dropdown">
                              ...
                              <div class="dropdown-menu">
                                ...
                                <a class="dropdown-item" href="<?= base_url('admin/edit-transaction/'.$value['id']); ?>"><i class="bx bx-edit-alt me-1"></i> Edit</a>
                                <form action="<?= base_url('admin/transaction/delete') ?>" method="POST" style="display:inline;">
