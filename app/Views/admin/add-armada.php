...
<html
  ...
  <head>
    ...
    <link rel="stylesheet" href="<?= base_url('/'); ?>dashboard/assets/vendoree/fonts/boxicons.css" />
                      ...
                      <div class="form-group">
                        <div class="row">
                          <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control" name="no_register" placeholder="B 1234 XX" id="no_register" required>
                          </div>
                          <div class="col-md-6 mb-3">
                            <label for="nama_pemilik" class="form-label">Nama Pemilik</label>
                            <input class="form-control" type="text" name="nama_pemilik" placeholder="atas nama kendaraan.." id="nama_pemilik" required>
                          </div>
                        </div>
                      </div>
                      <div class="mb-3">
                        <label for="alamat" class="form-label">Alamat</label>
                        <textarea class="form-control" name="alamat" id="alamat" rows="3" placeholder="alamat kendaraan.."></textarea>
                      </div>
                      <div class="form-group">
                        <div class="row">
                          <div class="col-md-6 mb-3">
                            <label for="merk" class="form-label">Merk</label>
                            <input class="form-control" type="text" name="merk" placeholder="TOYOTA" id="merk" required>
                          </div>
                          <div class="col-md-6 mb-3">
                            <label for="warna_kb" class="form-label">Warna Kendaraan</label>
                            <input class="form-control" warna_kb="text" name="warna_kb" placeholder="HITAM" id="warna_kb" required>
                          </div>
                        </div>
                      </div>
                      <div class="mb-3">
                        <label for="type" class="form-label">Type</label>
                        <input class="form-control" type="text" name="type" placeholder="AVANZA" id="type" required>
                      </div>
                      <div class="form-group">
                        <div class="row">
                          <div class="col-md-4 mb-3">
                            <label for="jenis" class="form-label">Jenis</label>
                            <input class="form-control" type="text" name="jenis" placeholder="MINIBUS" id="jenis" required>
                          </div>
                          <div class="col-md-4 mb-3">
                            <label for="tahun" class="form-label">Tahun</label>
                            <input class="form-control" type="number" name="tahun" placeholder="2021" id="tahun" required>
                          </div>
                          <div class="col-md-4 mb-3">
                            <label for="cc" class="form-label">Kapasitas Mesin (CC)</label>
                            <input class="form-control" type="number" name="cc" placeholder="1500" id="cc" required>
                          </div>
                        </div>
                      </div>
                      <div class="mb-3">
                        <label for="no_rangka" class="form-label">Nomor Rangka</label>
                        <input class="form-control" type="text" name="no_rangka" placeholder="4S5BMHB68B3286051" id="no_rangka" required>
                      </div>
                      <div class="mb-3">
                        <label for="no_mesin" class="form-label">Nomor Mesin</label>
                        <input class="form-control" type="text" name="no_mesin" placeholder="NS150E8002932" id="no_mesin" required>
                      </div>
                      <div class="form-group">
                        <div class="row">
                          <div class="col-md-6 mb-3">
                            <label for="masa_berlaku" class="form-label">Bahan Bakar</label>
                            <input class="form-control" type="text" name="bahan_bakar" placeholder="BENSIN" id="bahan_bakar" required>
                          </div>
                          <div class="col-md-6 mb-3">
                            <label for="masa_berlaku" class="form-label">Berlaku Sampai</label>
                            <input class="form-control" type="date" name="masa_berlaku" id="masa_berlaku" required>
                          </div>
                        </div>
                      </div>
                      <hr>
