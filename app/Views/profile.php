...
<body>
    ...
    <div class="layout-container">
      ...
      <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
        ...
        <ul class="menu-inner py-1">
          ...
          <li class="menu-item">
            <a href="<?= base_url('user/car-list'); ?>" class="menu-link">
                ...
                <div class="card mb-4">
                  ...
                  <div class="card-body">
                    ...
                    <div class="mb-3">
                      ...
                      <img src="https://picsum.photos/200" alt="image-preview" id="previewImage" class="mt-3">
                    </div>
                    <hr>
                    <div class="form-group">
                      <div class="row">
  ...
  <script>
    ...
    const imageOriginal = imagePreview.getAttribute('src');


    function resetForm() {
      document.getElementById('formUser').reset();
      imagePreview.attributes.src.value = imageOriginal;
    }
